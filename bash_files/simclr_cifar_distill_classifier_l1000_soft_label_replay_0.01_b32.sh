python3 main_continual.py \
    ...
    --name cifar100-simclr-contrastive-distill-classifier-l1000-soft-label-replay-0.01-b32 \
    ...
    --pretrained_model experiments/2022_08_31_14_49_21-cifar100-simclr-contrastive-distill-classifier-l1000-lamb5-soft-label-replay-0.1/task0-1o6mzete/cifar100-simclr-contrastive-distill-classifier-l1000-lamb5-soft-label-replay-0.1-task0-ep=499-1o6mzete.ckpt
