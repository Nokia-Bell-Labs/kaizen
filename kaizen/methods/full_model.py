...
class FullModel(pl.LightningModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.classifier = classifier if classifier is not None else nn.Linear(self.backbone.inplanes, num_classes)  # type: ignore
    ...
    def add_model_specific_args(parent_parser: ArgumentParser) -> ArgumentParser:
        ...
        parser.add_argument("--online_eval_classifier_layers", type=int, default=[], nargs="*", help="Duplication for classifier_layers")
    ...
    def training_step(self, batch: torch.Tensor, batch_idx: int) -> torch.Tensor:
        ...
        log = {"train_loss": loss.detach().double(), "train_acc1": acc1.detach(), "train_acc5": acc5.detach()}
