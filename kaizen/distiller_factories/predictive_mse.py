...
from kaizen.losses.vicreg import invariance_loss
from kaizen.args.utils import strtobool

def predictive_mse_distill_factory(
    ...
    class PredictiveMSEDistillWrapper(Method):
        ...
        def add_model_specific_args(
            ...
            parser = parent_parser.add_argument_group(f"predictive_mse_{class_tag}_distiller")

            parser.add_argument(f"--{distill_lamb_name}", type=float, default=25)
        ...
        def training_step(self, batch: Sequence[Any], batch_idx: int) -> torch.Tensor:
            ...
            self.log(f"train_{class_tag}_predictive_mse_distill_loss", distill_loss, on_epoch=True, sync_dist=True)
